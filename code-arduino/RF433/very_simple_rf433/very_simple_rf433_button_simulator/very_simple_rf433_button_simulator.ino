...
void loop()
{
    TRIG1_SET;   TRIG2_CLEAR; TRIG3_CLEAR; TRIG4_CLEAR; _delay_ms( 6 );
    TRIG1_CLEAR; TRIG2_SET;   TRIG3_CLEAR; TRIG4_CLEAR; _delay_ms( 6 );
    TRIG1_CLEAR; TRIG2_CLEAR; TRIG3_SET;   TRIG4_CLEAR; _delay_ms( 6 );
    TRIG1_CLEAR; TRIG2_CLEAR; TRIG3_CLEAR; TRIG4_SET;   _delay_ms( 6 );
    L13_TOGGLE;
}
